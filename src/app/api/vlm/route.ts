...
- **手写长文本（中文/英文句子或段落，字数>20，非题目）：只输出1个意图，name="写作帮助"**
类型C（字词查询，第2张只包含单个汉字/词语/单词/短句，无完整题目结构）：输出1个意图，推断具体学习目的（如查字词）。不要被第1张大图的整体场景误导——重点看第2张的内容本身

【字段】每意图包含：
- name: 意图名称。如"比较分数大小""理解勾股定理""查拼音""写作帮助"。单意图禁止输出"第1题"；多题写"第1题""第2题"
